...
import { $, escapeHtml, truncateName, truncateByGraphemeVisible, logWarn, replaceBadgeEmoji } from '../../utils/utils.js';
...
export async function openHiddenTagCharModal() {
  try {
    const { showHiddenTagCharModal } = await import('../../ui/modals/modals.js');
    const noteInput = $('#noteInput');
    if (!noteInput) {
