 ...
 * GeoRelayDirectory
 * 
 * 地理的なNostrリレーの取得、キャッシュ、および距離計算を
 * georelaysデータベースに基づいて処理します。
 */
...
/**
 * ジオハッシュ文字列をデコードして、そのセルの中心の緯度と経度を返します。
 */
...
/**
 * 2つの座標セット間のハバーシン距離（キロメートル）を計算します。
 */
...
/**
 * georelaysデータベースからのCSV文字列をパースします。
 */
