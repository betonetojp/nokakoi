...
import { uniqueRelays, $, logWarn } from '../utils/utils.js';
import { EVENTS_TIMEOUT, RECONNECT_DELAY, MAX_RECONNECT_DELAY, DOWN_PERSIST_MS, MAX_LIVE_PER_RELAY, MAX_ONESHOT_PER_RELAY, MAX_TOTAL_SUB_PER_RELAY, KEEPALIVE_INTERVAL, RESUME_RESTART_MS, RELAY_MONITOR_INTERVAL, MAX_PRIORITY_SUB_PER_RELAY, PER_RELAY_ONESHOT_LIMIT } from '../config/constants.js';
...
const subscribeQueue = []; // { targetRelays, filters, dispatcher, resolve, reject, subId, type } の配列
