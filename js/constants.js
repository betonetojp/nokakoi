// 共通定数（フィード・モーダルで共通利用）
export const EVENTS_TIMEOUT = 8000; // ms - safety timeout for per-relay queries
...
export const RESUME_RESTART_MS = 5000; // ms - この時間以上バックグラウンドだったら復帰時にフィードを強制再購読
...
export const MAX_PRIORITY_SUB_PER_RELAY = 12; // リレーごとの同時優先合計購読上限
...
// Event link（lumilumi）の既定値
export const EVENTLINK_DEFAULT_TITLE = 'lumilumi';
export const EVENTLINK_DEFAULT_URL = 'https://lumilumi.app/';
